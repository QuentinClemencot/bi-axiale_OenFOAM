...
nRevRegular=40 # number of revolutions made (to reach permanent state) []
...
nRevProbes=1 # number of extra revolutions made to collect probes []
nStep_per_revProbes=  nStep_per_revRegular # number of time step per period []
...
writeInterval_surface=1 # write p and wss along blades surface every 'writeInterval_surface' time step.

writeInterval_timeDir_reg=600 # write time directory every "writeInterval_timeDir" time step
timeDir_perCycle_probes=40 # write time directory X times par cycle during 'probing cycles'
